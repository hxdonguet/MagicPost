    ...
    return (
        <div>
            <div className={style.backgroundmodau}>
                <Link to='/About'><img src='https://admin.ems.com.vn/filemedia/banner/COVER-01.1632703703.jpg'></img></Link>
            </div>
            <div className={style.lookuppostal}>
                <div className={style.containermd}>
                    <div className={style.roww}>
                        <div className={style.codmd512}>
                            <div className={style.lookaction}>
                                ...
                                <div className={style.dflex}>
                                    <input type="text" placeholder="Nhập mã bưu gửi" name="id" onChange={handleInput}></input>
                                    <div className={style.btnsearch} onClick={handleClick}>
                                        <img src="https://ems.com.vn/img/icon/search-white.png" ></img>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={style.flexcol}>
                            <Link to='/MPEstimate' className={style.aa}>
                        ...
                        <div className={style.flexcol}>
                            <Link to='/MPFindPost' className={style.aa}>
                                <div className={style.lookitemmm}>
                                    <div className={style.amount}>
                                        <img src="https://ems.com.vn/img/icon/search-post.png"></img>
                                    </div>
                        ...
                        <div className={style.flexcol}>
                            <Link to='/ProhibitedDetails' className={style.aa}>
                                <div className={style.lookitemmm}>
                                    <div className={style.amount}>
            ...
            <div className={style.servicess}>
                ...
                <div className={style.containdv}>
                    ...
                    <div className={style.anotherdv}>
                        <Link className={style.buton} to='/MPAnotherServices'>Các dịch vụ khác...</Link>
                    </div>
                </div>
            </div>
                        ...
                        <div className={style.formct}>
                            ...
                            <form className={style.maulienhe}>
                                <div className={style.ndc}>
                                    <input required="" placeholder="Tên của bạn..." name="name" autoComplete="off" type="text" ></input>
                                </div>
                                <div className={style.ndc}>
                                    <input required="" placeholder="Email của bạn..." name="name" autoComplete="off" type="text" ></input>
                                </div>
                                <div className={style.ndc}>
                                    <textarea required="" placeholder="Nội dung của bạn..." name="name" autoComplete="off" type="text" ></textarea>
                                </div>
