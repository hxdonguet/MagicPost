...
import style from './MPTaiLieu.module.css'
            ...
            <div className={style.subbanner5}>
                ...
                <div className={style.title5}>
                    <div className={style.contain5}>
                        <span className={style.tieude5}>MAGICPOST TÀI LIỆU</span>
                    </div>
                </div>
            </div>
            <div className={style.containdvtl}>
                <div className={style.service1}>
                    <h1 className={style.tieudedv1}>
                        <strong className={style.chimucdv1}>MAGICPOST TÀI LIỆU</strong>
                    </h1>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>ĐỊNH NGHĨA</strong>
                    </h2>
                    <hr></hr>
                    <p><strong>MagicPost Tài liệu&nbsp;</strong>là dịch vụ nhận gửi, vận chuyển và phát các loại thư, tài liệu&nbsp;trong nước theo chỉ tiêu thời gian tiêu chuẩn được Tổng công ty MagicPost công bố.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>PHẠM VI CUNG CẤP</strong>
                    </h2>
                    <hr></hr>
                    <p>Dịch vụ <strong>MagicPost Tài liệu&nbsp;</strong>được cung cấp tại 63 tỉnh, thành phố trong cả nước.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>BẢNG GIÁ CƯỚC DỊCH VỤ MAGICOST TÀI LIỆU</strong>
                    </h2>
                    <hr></hr>
                    <img src='https://admin.ems.com.vn/filemedia/upload/G%C3%B3i%20d%E1%BB%8Bch%20v%E1%BB%A5%20(2).1697989600.png'></img>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>CHỈ TIÊU THỜI GIAN TOÀN TRÌNH</strong>
                    </h2>
                    <hr></hr>
                    <img src='https://admin.ems.com.vn/filemedia/upload/ch%E1%BB%89%20ti%C3%AAu.1688352703.png'></img>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>KHU VỰC VÀ VÙNG TÍNH CƯỚC</strong>
                    </h2>
                    <hr></hr>
                    <img src='https://admin.ems.com.vn/filemedia/upload/Khu%20v%E1%BB%B1c%20v%C3%A0%20v%C3%B9ng%20t%C3%ADnh%20c%C6%B0%E1%BB%9Bc.1649730308.jpg'></img>
                    ...
                    <p><strong className={style.chimuc1dv1}>Ghi chú:</strong></p>
                    <p>- Bảng giá trên đã bao gồm thuế VAT (10%) và phụ phí xăng dầu, phụ phí vùng xa.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>DỊCH VỤ GTGT</strong>
                    </h2>
                    <hr></hr>
                    <img src='https://admin.ems.com.vn/filemedia/upload/c%E1%BB%99ng%20th%C3%AAm.1688353162.png'></img>
                    <p><strong className={style.chimuc1dv1}>Ghi chú:</strong></p>
                    <p>- Bảng giá cước dịch vụ cộng thêm chưa bao gồm cước chính.</p>
                    <p>- Bảng giá trên chưa bao gồm thuế VAT (10%) và phụ phí xăng dầu, phụ phí vùng xa.</p>
                    <h2 className={style.chimuc1dv1}>
