...
import style from './LastMile.module.css'
            ...
            <div className={style.subbanner5}>
                ...
                <div className={style.title5}>
                    <div className={style.contain5}>
                        <span className={style.tieude5}>LAST MILE</span>
                    </div>
                </div>
            </div>
            <div className={style.containdvtl}>
                <div className={style.service1}>
                    <h1 className={style.tieudedv1}>
                        <strong className={style.chimucdv1}>DỊCH VỤ LOGISTICS CÔNG ĐOẠN CUỐI (LAST MILE LOGISTICS)</strong>
                    </h1>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>ĐỊNH NGHĨA</strong>
                    </h2>
                    <hr></hr>
                    <p><strong>Dịch vụ Logistics công đoạn cuối (Last Mile Logistics):&nbsp;</strong>Là một chuỗi giải pháp giao nhận hàng tại kho hàng nhà máy (Warehouse - WH), trung tâm phân phối (Distribution Center - DC) của khách hàng; vận chuyển đến đầu tỉnh, thành phố (Warehouse - Province); giao nhận với đội phát của khách hàng tại tỉnh/thành phố (điểm bán lẻ); tổ chức vận chuyển và phát đến người nhận trên địa bàn tỉnh/thành phố đó; cung cấp các giải pháp, dịch vụ gia tăng khác khi khách hàng có yêu cầu (thu hộ, vận chuyển hàng đổi trả,…). </p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>PHẠM VI CUNG CẤP</strong>
                    </h2>
                    <hr></hr>
                    <p><strong>Dịch vụ Logistics công đoạn cuối (Last Mile Logistics)&nbsp;</strong>được cung cấp tại 63 tỉnh, thành phố trong cả nước.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>GIÁ CƯỚC</strong>
                    </h2>
                    <hr></hr>
                    <p>Xây dựng theo từng giải pháp cung cấp cho khách hàng cụ thể.</p>
                    <h2 className={style.chimuc1dv1}>
