...
import style from './Forwarder.module.css'
            ...
            <div className={style.subbanner5}>
                ...
                <div className={style.title5}>
                    <div className={style.contain5}>
                        <span className={style.tieude5}>FORWARDER</span>
                    </div>
                </div>
            </div>
            <div className={style.containdvtl}>
                <div className={style.service1}>
                    <h1 className={style.tieudedv1}>
                        <strong className={style.chimucdv1}>DỊCH VỤ GIAO NHẬN VẬN TẢI (LOGISTICS FORWARDER)</strong>
                    </h1>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>ĐỊNH NGHĨA</strong>
                    </h2>
                    <hr></hr>
                    <p><strong>Dịch vụ Giao nhận vận tải (Logistics Forwarder)&nbsp;</strong>là dịch vụ Logistics của Tổng Công ty Chuyển phát nhanh Bưu điện – CTCP (Tổng Công ty MagicPost) cung cấp cho khách hàng có nhu cầu vận chuyển hàng hóa từ nơi gửi hàng đến nơi nhận hàng bằng một hoặc nhiều phương thức vận tải khác nhau. </p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>PHẠM VI CUNG CẤP</strong>
                    </h2>
                    <hr></hr>
                    <p><strong>Dịch vụ Giao nhận vận tải (Logistics Forwarder)&nbsp;</strong>được cung cấp tại 63 tỉnh, thành phố trong cả nước.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>GIÁ CƯỚC</strong>
                    </h2>
                    <hr></hr>
                    <p>Xây dựng theo từng giải pháp giao nhận vận chuyển cung cấp cho khách hàng cụ thể.</p>
                    <h2 className={style.chimuc1dv1}>
                        <strong className={style.chimucdv1}>PHƯƠNG THỨC CUNG CẤP DỊCH VỤ</strong>
                    </h2>
                    <hr></hr>
                    <p>- Giao nhận vận tải <strong>Door - Door:</strong> Là phương thức nhận hàng tại địa chỉ của người gửi, vận chuyển và giao đến địa chỉ của người nhận hàng.</p>
                    <p>- Giao nhận vận tải <strong>Hub - Door:</strong> Là phương thức nhận hàng tại Hub khai thác hàng Logistics của Tổng Công ty MagicPost và giao hàng đến địa chỉ của người nhận hàng.</p>
                    <p>- Giao nhận vận tải <strong>Door - Hub:</strong> Là phương thức nhận hàng tại địa chỉ của người gửi, vận chuyển và giao hàng cho người nhận tại Hub khai thác.</p>
                    <p>- Giao nhận vận tải <strong> Hub - Hub:</strong> Là phương thức nhận hàng tại Hub khai thác, vận chuyển và giao hàng cho người nhận tại Hub khai thác.</p>
                    <h2 className={style.chimuc1dv1}>
