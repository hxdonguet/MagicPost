...
import style from './PackageTransportation.module.css'
...
function PackageTransportation() {
                ...
                <td className={style.text_center}>
                  <div className={style.btn_group}>
                    <div className={style.container_popup}>
                      <button className={`${style.btn} ${style.btn_transportation}`}>
                        {e.status}
                      </button>
                    </div>
                  </div>
...
export default PackageTransportation
